...
@section('content')
            ...
            <div class="row align-items-center justify-content-center">
                ...
                <div class="col-12 col-lg-7 col-md-9 padding-55px-lr md-padding-5px-left sm-padding-50px-right">
                    <figure class="image-back-offset-shadow position-right w-100">
                        <img class="border-radius-6px" src="images/our-services-01.jpg" alt=""/>
    ...
    <section class="wow animate__fadeIn">
        <div class="container">
            ...
            <div class="row align-items-center justify-content-center">
                <!-- start pricing item -->
                <div class="col-12 col-lg-4 col-md-7 text-center md-margin-30px-bottom wow animate__fadeIn" data-wow-delay="0.4s">
                ...
                <!-- end pricing item -->
                <!-- start pricing item -->
                <div class="col-12 col-lg-4 col-md-7 text-center md-margin-30px-bottom wow animate__fadeIn" data-wow-delay="0.2s">
                ...
                <!-- end pricing item -->
                <!-- start pricing item -->
                <div class="col-12 col-lg-4 col-md-7 text-center wow animate__fadeIn" data-wow-delay="0.4s">
                    <div class="pricing-table bg-white border-radius-6px padding-60px-lr padding-70px-tb lg-padding-45px-lr lg-padding-60px-tb">
                        <div class="pricing-header">
